...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: "bold", color: "#161616", marginBottom: 2 },
  goldLine: { height: 2, backgroundColor: "#c9a84c", marginBottom: 16, width: 60 },
  sectionLabel: {
    fontSize: 8,
    fontWeight: "bold",
    color: "#8a7429",
  ...
  vatNote: { fontSize: 8, color: "#555", marginTop: 10, marginBottom: 10 },
